		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityModelAccess().getEntityModelElementsAssignment(), "rule__EntityModel__EntityModelElementsAssignment");
					...
					put(grammarAccess.getEntityAccess().getFeaturesAssignment_8_1(), "rule__Entity__FeaturesAssignment_8_1");
					put(grammarAccess.getAttributeAccess().getNameAssignment_1(), "rule__Attribute__NameAssignment_1");
					put(grammarAccess.getAttributeAccess().getMandatoryAssignment_2(), "rule__Attribute__MandatoryAssignment_2");
